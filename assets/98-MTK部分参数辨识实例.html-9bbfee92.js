import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,f as t}from"./app-6a7f54ea.js";const e="/assets/image/06Optimization/DiffEqParamEstim_Li_batter_1.png",p="/assets/image/06Optimization/DiffEqParamEstim_Li_batter_2.png",o="/assets/image/06Optimization/DiffEqParamEstim_Li_batter_3.png",c="/assets/image/06Optimization/DiffEqParamEstim_Li_batter_4.png",i="/assets/image/06Optimization/DiffEqParamEstim_Li_batter_5.png",l="/assets/image/06Optimization/DiffEqParamEstim_Li_batter_6.png",u={},r=t(`<h1 id="mtk部分参数辨识实例" tabindex="-1"><a class="header-anchor" href="#mtk部分参数辨识实例" aria-hidden="true">#</a> MTK部分参数辨识实例</h1><p>!!! tip<br> Contents：MTK模型、优化、DiffEqParamEstim</p><pre><code>Contributor: HY
