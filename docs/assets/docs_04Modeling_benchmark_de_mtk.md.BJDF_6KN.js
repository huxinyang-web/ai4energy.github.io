import{_ as a,o as n,c as p,ae as e}from"./chunks/framework.Pte9XX0l.js";const h=JSON.parse('{"title":"MTK为什么比DE慢？","description":"","frontmatter":{},"headers":[],"relativePath":"docs/04Modeling/benchmark_de_mtk.md","filePath":"docs/04Modeling/benchmark_de_mtk.md","lastUpdated":1773485796000}'),t={name:"docs/04Modeling/benchmark_de_mtk.md"};function l(i,s,c,o,r,d){return n(),p("div",null,[...s[0]||(s[0]=[e(`<h1 id="mtk为什么比de慢" tabindex="-1">MTK为什么比DE慢？ <a class="header-anchor" href="#mtk为什么比de慢" aria-label="Permalink to &quot;MTK为什么比DE慢？&quot;">​</a></h1><div class="tip custom-block"><p class="custom-block-title">TIP</p><pre><code>Contents：代码优化
